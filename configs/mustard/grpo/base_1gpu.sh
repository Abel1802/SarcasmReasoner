...
#
# Training data:
#   train = 841 source instances
#
# Validation data:
#   valid = 180 source instances
#
# Test data:
...
#
# Validation:
#   stochastic GRPO reward evaluation every 200 steps
...
OUTPUT_DIR="results/mustard/grpo/base"
...
#
# Train:
#   - 841 original MUStARD++ train sources
#   - G=8 stochastic rollouts
#   - 1 epoch
#
# Validation:
#   - 180 held-out validation sources
#   - no parameter updates
#   - G_eval=8 stochastic rollouts
#   - reward evaluation every 200 optimizer steps
#
# Checkpoints:
#   - ~200
#   - ~400
...
echo
echo "============================================================"
echo "MUStARD++ Base -> GRPO finished"
echo "============================================================"
