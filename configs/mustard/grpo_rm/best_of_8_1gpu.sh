...
OUTPUT_DIR="results/mustard/grpo_rm/best_of_8"
...
echo "============================================================"
echo "MUStARD++ Best-of-8-SFT -> GRPO + GenRM"
echo "============================================================"
echo
...
#          +
#   Best-of-8-SFT checkpoint-105
#
# Reference policy:
#
#   same base model
#          +
#   same Best-of-8-SFT checkpoint-105
#
# Reward:
#
#   accuracy      1.0
...
echo
echo "============================================================"
echo "MUStARD++ Best-of-8-SFT -> GRPO + GenRM finished"
echo "============================================================"
