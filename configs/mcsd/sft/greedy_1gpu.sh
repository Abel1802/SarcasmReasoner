...
TRAIN_DATA="data/mcsd/processed/sft/greedy_train.jsonl"
VALID_DATA="data/mcsd/processed/sft/greedy_valid.jsonl"

OUTPUT_DIR="results/mcsd/sft/greedy"
