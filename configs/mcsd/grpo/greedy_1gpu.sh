...
#   - Load the same SFT adapter as:
#         policy initialization: --adapters
...
#
# In ms-swift GRPO:
# per_device_eval_batch_size refers to completion batch size.
#
# Single GPU:
#   8 completions
#   = 1 prompt x 8 generations
# ------------------------------------------------------------
...
# Audio is explicitly provided separately.
export USE_AUDIO_IN_VIDEO=False

# Keep preprocessing consistent with teacher generation / SFT.
...
#   Qwen/Qwen2.5-Omni-7B
#          +
#   same Greedy-SFT LoRA
#
#
# GRPO optimizer and LR scheduler start fresh.
#
