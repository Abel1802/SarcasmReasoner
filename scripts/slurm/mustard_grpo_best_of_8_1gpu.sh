...
#SBATCH --output=logs/mustard_best8_grpo_%j.out
#SBATCH --error=logs/mustard_best8_grpo_%j.err
...
# ============================================================
# MUStARD++ Best-of-8-SFT -> GRPO
# ============================================================


echo "============================================================"
echo "MUStARD++ Best-of-8-SFT -> GRPO"
echo "============================================================"
...
TRAIN_SCRIPT="configs/mustard/grpo/best_of_8_1gpu.sh"
...
echo "============================================================"
echo "Starting MUStARD++ Best-of-8-SFT -> GRPO"
echo "============================================================"
echo
...
echo
echo "============================================================"
echo "MUStARD++ Best-of-8-SFT -> GRPO job finished"
echo "============================================================"
