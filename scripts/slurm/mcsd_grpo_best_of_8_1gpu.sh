...
#SBATCH --job-name=mcsd_best8_grpo
...
#SBATCH --output=logs/mcsd_best8_grpo_%j.out
#SBATCH --error=logs/mcsd_best8_grpo_%j.err
...
# ============================================================
# MCSD Best-of-8-SFT -> GRPO
# ============================================================


echo "============================================================"
echo "MCSD Best-of-8-SFT -> GRPO"
echo "============================================================"
...
TRAIN_SCRIPT="configs/mcsd/grpo/best_of_8_1gpu.sh"
...
SFT_CKPT="results/mcsd/sft/best_of_8/v0-20260924-212847/checkpoint-315"
...
echo "Required files and Best-of-8 checkpoint found."
echo
...
echo "============================================================"
echo "Starting MCSD Best-of-8-SFT -> GRPO"
echo "============================================================"
echo
...
echo "  Same Best-of-8-SFT adapter"
echo
...
echo
echo "============================================================"
echo "MCSD Best-of-8-SFT -> GRPO job finished"
echo "============================================================"
