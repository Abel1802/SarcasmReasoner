...
#SBATCH --job-name=en_greedy_grpo
...
#SBATCH --output=logs/mustard_greedy_grpo_%j.out
#SBATCH --error=logs/mustard_greedy_grpo_%j.err
...
# Validation:
#   180 sources
#   GRPO reward evaluation every 200 steps
#
# GRPO:
#   G = 8
#   1 epoch
...
TRAIN_SCRIPT="configs/mustard/grpo/greedy_1gpu.sh"
