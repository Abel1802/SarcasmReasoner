...
#SBATCH --job-name=mustard_base_grpo
...
#SBATCH --output=logs/mustard_base_grpo_%j.out
#SBATCH --error=logs/mustard_base_grpo_%j.err
...
# Validation:
#   180 sources
#   GRPO reward evaluation every 200 optimizer steps
#
# Hardware:
#   1 x H100
# ============================================================
...
TRAIN_SCRIPT="configs/mustard/grpo/base_1gpu.sh"
...
echo "============================================================"
echo "Starting formal MUStARD++ Base -> GRPO"
echo "============================================================"
echo
...
echo
echo "============================================================"
echo "MUStARD++ Base -> GRPO job finished"
echo "============================================================"
