...
#SBATCH --job-name=mcsd_diverse_8_sft
...
#SBATCH --output=logs/mcsd_diverse_8_sft_%j.out
#SBATCH --error=logs/mcsd_diverse_8_sft_%j.err
...
TRAIN_SCRIPT="configs/mcsd/sft/diverse_8_1gpu.sh"
...
echo "============================================================"
echo "Starting MCSD Diverse-8 SFT"
echo "============================================================"
echo
...
echo
echo "============================================================"
echo "MCSD Diverse-8 SFT job finished"
echo "============================================================"
