...
#SBATCH --job-name=mcsd_best_of_8_sft
...
#SBATCH --output=logs/mcsd_best_of_8_sft_%j.out
#SBATCH --error=logs/mcsd_best_of_8_sft_%j.err
...
TRAIN_SCRIPT="configs/mcsd/sft/best_of_8_1gpu.sh"
...
echo "============================================================"
echo "Starting MCSD Best-of-8 SFT"
echo "============================================================"
echo
...
echo
echo "============================================================"
echo "MCSD Best-of-8 SFT job finished"
echo "============================================================"
