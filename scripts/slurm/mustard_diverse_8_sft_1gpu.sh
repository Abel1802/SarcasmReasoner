...
#SBATCH --job-name=mustard_div8_sft
...
#SBATCH --output=logs/mustard_div8_sft_%j.out
#SBATCH --error=logs/mustard_div8_sft_%j.err
...
TRAIN_SCRIPT="configs/mustard/sft/diverse_8_1gpu.sh"
...
echo "Diverse-8 dataset:"
echo "  train: $TRAIN_SIZE"
echo "  valid: $VALID_SIZE"
echo


if [ "$TRAIN_SIZE" -ne 4447 ]; then
    echo "ERROR: expected 4447 training examples, got $TRAIN_SIZE"
    exit 1
fi

if [ "$VALID_SIZE" -ne 980 ]; then
    echo "ERROR: expected 980 validation examples, got $VALID_SIZE"
    exit 1
fi
...
echo
echo "============================================================"
echo "Starting MUStARD++ Diverse-8 SFT"
echo "============================================================"
echo
...
echo
echo "============================================================"
echo "MUStARD++ Diverse-8 SFT job finished"
echo "============================================================"
